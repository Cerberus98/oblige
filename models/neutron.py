...
username = "root" #config.get('source_db', 'user', 'changeuserinconfig')
password = "" #config.get('source_db', 'password', 'changepasswordinconfig')
location = "localhost" #config.get('source_db', 'location', 'changelocationinconfig')
dbname = "quark" #config.get('source_db', 'dbname', 'changedatabasenameinconfig')
